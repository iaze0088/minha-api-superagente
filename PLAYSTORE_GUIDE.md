...
# Inicializar projeto
bubblewrap init --manifest https://reseller-sync.preview.emergentagent.com/manifest.json
```
...
4. **Host URL:** https://reseller-sync.preview.emergentagent.com
5. **Theme Color:** #075e54
6. **Background Color:** #075e54
7. **Icon URL:** https://reseller-sync.preview.emergentagent.com/icon-512.png
8. **Maskable Icon:** https://reseller-sync.preview.emergentagent.com/icon-512.png
...
2. Cole a URL: `https://reseller-sync.preview.emergentagent.com`
...
6. Configure:
   ...
   - **Launch URL:** https://reseller-sync.preview.emergentagent.com
...
pwa-builder --package https://reseller-sync.preview.emergentagent.com --android
```
...
```
https://reseller-sync.preview.emergentagent.com/.well-known/assetlinks.json
```
