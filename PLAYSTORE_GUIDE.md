...
# Inicializar projeto
bubblewrap init --manifest https://cybertv-support-1.preview.emergentagent.com/manifest.json
```
...
4. **Host URL:** https://cybertv-support-1.preview.emergentagent.com
5. **Theme Color:** #075e54
6. **Background Color:** #075e54
7. **Icon URL:** https://cybertv-support-1.preview.emergentagent.com/icon-512.png
8. **Maskable Icon:** https://cybertv-support-1.preview.emergentagent.com/icon-512.png
...
2. Cole a URL: `https://cybertv-support-1.preview.emergentagent.com`
...
6. Configure:
   ...
   - **Launch URL:** https://cybertv-support-1.preview.emergentagent.com
...
pwa-builder --package https://cybertv-support-1.preview.emergentagent.com --android
```
...
```
https://cybertv-support-1.preview.emergentagent.com/.well-known/assetlinks.json
```
