...
# Inicializar projeto
bubblewrap init --manifest https://iptv-support-hub.preview.emergentagent.com/manifest.json
```
...
4. **Host URL:** https://iptv-support-hub.preview.emergentagent.com
5. **Theme Color:** #075e54
6. **Background Color:** #075e54
7. **Icon URL:** https://iptv-support-hub.preview.emergentagent.com/icon-512.png
8. **Maskable Icon:** https://iptv-support-hub.preview.emergentagent.com/icon-512.png
...
2. Cole a URL: `https://iptv-support-hub.preview.emergentagent.com`
...
6. Configure:
   ...
   - **Launch URL:** https://iptv-support-hub.preview.emergentagent.com
...
pwa-builder --package https://iptv-support-hub.preview.emergentagent.com --android
```
...
```
https://iptv-support-hub.preview.emergentagent.com/.well-known/assetlinks.json
```
